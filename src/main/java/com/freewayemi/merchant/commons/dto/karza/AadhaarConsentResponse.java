...
@Data
@JsonDeserialize(builder = AadhaarConsentResponse.AadhaarConsentResponseBuilder.class)
@Builder(builderClassName = "AadhaarConsentResponseBuilder", toBuilder = true)
public class AadhaarConsentResponse {
    ...
    public static class AadhaarConsentResponseBuilder {
    }
